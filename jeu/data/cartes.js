...
export const CARTES = {
  ...
  "ecrasement": {
    ...
    cout: 2,
    type: "attaque",
    texte: "Deal 10 damage. Gain 5 Stone.",
    effets: [{ type: "degats", valeur: 10 }, { type: "pierre", valeur: 5 }],
  },
  ...
  "eclaboussure-de-frappe": {
    ...
    cout: 3,
    type: "attaque",
    texte: "Deal 18 damage. Each adjacent enemy has a 50% chance to take 4 Burning.",
    effets: [{ type: "degats", valeur: 18 }, { type: "brulure-adjacent", feu: 4, proba: 0.5 }],
  },
  ...
  "coup-venimeux": {
    ...
    cout: 1,
    type: "attaque",
    texte: "Deal 10 damage. Apply 5 Poison.",
    effets: [{ type: "degats", valeur: 10 }, { type: "poison", valeur: 5 }],
  },
  ...
  "danse-empoisonnee": {
    ...
    type: "attaque",
    aoe: true,
    texte: "Hit ALL enemies 3 times for 6 damage. Apply 2 Poison per hit (4 if the enemy was already poisoned).",
    effets: [{ type: "danse-poison", hits: 3, degats: 6, poison: 2 }],
  },
  ...
  "explosion-poison": {
    ...
    type: "attaque",
    portee: "range",
    texte: "Deal damage equal to the target's Poison to it and each adjacent enemy, then apply 5 Poison to them all (Poison is not consumed).",
    effets: [{ type: "explosion-poison", poison: 5 }],
  },
  ...
  "coup-de-lave": {
    ...
    cout: 2,
    type: "attaque",
    texte: "Deal 30 damage. Apply 6 Burning.",
    effets: [{ type: "degats", valeur: 30 }, { type: "feu", valeur: 6 }],
  },
  ...
  "feu-frappe": {
    ...
    cout: 1,
    type: "attaque",
    texte: "Deal 15 damage. Apply 4 Burning.",
    effets: [{ type: "degats", valeur: 15 }, { type: "feu", valeur: 4 }],
  },
  ...
  "givre-lent": {
    ...
    type: "attaque",
    portee: "range",
    texte: "Deal 6 damage. Apply 4 Chill.",
    effets: [{ type: "degats", valeur: 6 }, { type: "lenteur", valeur: 4 }],
  },
  ...
  "coup-de-sang": {
    ...
    type: "attaque",
    portee: "range",
    texte: "Deal 6 damage. Apply 3 Bleed.",
    effets: [{ type: "degats", valeur: 6 }, { type: "sang", valeur: 3 }],
  },
  ...
  "giant-swing": {
    ...
    type: "attaque",
    aoe: true,
    texte: "Deal 24 damage to ALL enemies. Apply 4 Bleed to ALL enemies.",
    effets: [{ type: "degats", valeur: 24 }, { type: "sang", valeur: 4 }],
  },
  ...
  "couper-en-deux": {
    ...
    cout: 3,
    type: "attaque",
    texte: "Deal 50 damage. If the target dies, deal 24 damage to the next enemy.",
    effets: [{ type: "degats", valeur: 50 }, { type: "rebond", valeur: 24 }],
  },
  ...
  "mail-armor": {
    ...
    cout: 1,
    type: "defense",
    texte: "Gain 5 Stone for every enemy still alive.",
    effets: [{ type: "pierre-par-ennemi", valeur: 5 }],
  },
  ...
  "trempe": {
    ...
    cout: 0,
    type: "defense",
    texte: "Spend all Forge Heat. Gain 9 Stone per Heat spent.",
    effets: [{ type: "trempe", valeur: 9 }],
  },
  ...
  "embrasement-dragon": {
    ...
    portee: "range",
    aoe: true,
    texte: "Detonate all Burning: deal 5 damage per Burning on ALL enemies.",
    effets: [{ type: "embrasement", valeur: 5 }],
  },
  ...
  "onyx-radiance": {
    ...
    portee: "range",
    aoe: true,
    texte: "Apply 10 Burning to ALL enemies.",
    effets: [{ type: "feu", valeur: 10 }],
  },
  ...
  "onyx-slash": {
    ...
    cout: 2,
    type: "attaque",
    texte: "Deal 40 damage and 6 Burning. The enemy behind takes half (13 damage, 2 Burning).",
    effets: [
      { type: "degats", valeur: 40 },
      { type: "feu", valeur: 6 },
  ...
  "rejet-chaleur": {
    ...
    portee: "range",
    aoe: true,
    texte: "Spend all Forge Heat. Apply 7 Burning per Heat spent to ALL enemies.",
    effets: [{ type: "rejet-chaleur", valeur: 7 }],
  },
  ...
  "gel-cascade": {
    ...
    type: "attaque",
    portee: "range",
    texte: "Deal 16 damage and apply 7 Chill. If the target was already chilled, spread 7 Chill to the enemy behind — and keep spreading to each already-chilled enemy behind.",
    effets: [{ type: "gel-cascade", degats: 16, gel: 7 }],
  },
  ...
  "avantage-maille": {
    ...
    cout: 1,
    type: "buff",
    texte: "Gain 6 Stone and 2 Haste.",
    effets: [{ type: "pierre", valeur: 6 }, { type: "celerite", valeur: 2 }],
  },
  ...
  "second-souffle": {
    ...
    cout: 0,
    type: "buff",
    texte: "Trade 5 Haste for 4 Forge Heat. No effect below 5 Haste.",
    effets: [{ type: "celerite-vers-energie", cout: 5, gain: 4 }],
  },
  ...
  "boost-feu": {
    ...
    cout: 1,
    type: "buff",
    texte: "Convert up to 5 of your own Burning into 3 Forge Heat. No effect below 5 Burning.",
    effets: [{ type: "feu-vers-energie", cout: 5, gain: 3 }],
  },
  ...
  "armure-de-lumiere": {
    ...
    cout: 1,
    type: "defense",
    texte: "Gain 6 Stone. Dazzle the nearest enemy (1 Confusion).",
    effets: [{ type: "pierre", valeur: 6 }, { type: "confusion-proche", valeur: 1 }],
  },
  ...
  "lumiere-sacree": {
    ...
    type: "defense",
    texte: "Heal 20 HP.",
    effets: [{ type: "soin-heros", valeur: 20 }],
  },
  ...
  "imposition-des-mains": {
    ...
    cout: 1,
    type: "buff",
    texte: "Remove a random buff from the target. If one was removed, gain 5 Regen.",
    effets: [{ type: "supprimer-bonus", regen: 5 }],
  },
  ...
  "garde-sanguine": {
    ...
    cout: 1,
    type: "defense",
    texte: "Per Bleed among ALL enemies: gain 2 Stone and heal 5 HP.",
    effets: [{ type: "pierre-par-sang", valeur: 2 }, { type: "soin-par-sang", valeur: 5 }],
  },
  ...
  "bain-de-sang": {
    ...
    portee: "range",
    aoe: true,
    texte: "Take 20 damage. Apply 10 Bleed to ALL enemies.",
    effets: [{ type: "auto-degats", valeur: 20 }, { type: "sang", valeur: 10 }],
  },
  ...
  "boire-le-sang": {
    ...
    type: "attaque",
    aoe: true,
    texte: "Lose 20 HP. Deal 16 damage and 3 Bleed to ALL enemies. Heal 20 HP per enemy killed by this.",
    effets: [{ type: "boire-le-sang", hp: 20, degats: 16, sang: 3, soinMort: 20 }],
  },
  ...
  "ouvrir-les-veines": {
    ...
    type: "attaque",
    portee: "range",
    texte: "Take 10 damage. Apply 10 Bleed.",
    effets: [{ type: "auto-degats", valeur: 10 }, { type: "sang", valeur: 10 }],
  },
  ...
  "double-frappe": { id: "double-frappe", nom: "Double Strike", cout: 1, type: "attaque", nouveau: true,
    texte: "Deal 3 damage twice.", effets: [{ type: "degats", valeur: 3 }, { type: "degats", valeur: 3 }] },
  ...
  "entaille": { id: "entaille", nom: "Gash", cout: 1, type: "attaque", nouveau: true,
    texte: "Deal 4 damage. Apply 2 Bleed.", effets: [{ type: "degats", valeur: 4 }, { type: "sang", valeur: 2 }] },
  ...
  "eclat-de-glace": { id: "eclat-de-glace", nom: "Ice Shard", cout: 1, type: "attaque", nouveau: true,
    texte: "Deal 4 damage. Apply 2 Chill.", effets: [{ type: "degats", valeur: 4 }, { type: "lenteur", valeur: 2 }] },
  ...
  "braise": { id: "braise", nom: "Ember", cout: 1, type: "attaque", nouveau: true,
    texte: "Deal 3 damage. Apply 2 Burning.", effets: [{ type: "degats", valeur: 3 }, { type: "feu", valeur: 2 }] },
  ...
  "mur-de-fer": { id: "mur-de-fer", nom: "Iron Wall", cout: 1, type: "defense", nouveau: true,
    texte: "Gain 5 Stone.", effets: [{ type: "pierre", valeur: 5 }] },
  ...
  "brise-glace": { id: "brise-glace", nom: "Shatter", cout: 2, type: "attaque", nouveau: true,
    texte: "Deal 12 damage, +8 more if the target is Chilled.", effets: [{ type: "degats-si-gel", valeur: 12, bonus: 8 }] },
  ...
  "coup-de-force": { id: "coup-de-force", nom: "Power Strike", cout: 2, type: "attaque", nouveau: true,
    texte: "Deal 10 damage. Gain 3 Strength.", effets: [{ type: "degats", valeur: 10 }, { type: "force", valeur: 3 }] },
  ...
  "execution": { id: "execution", nom: "Execute", cout: 2, type: "attaque", nouveau: true,
    texte: "Deal 12 damage. Doubled if the target is below 50% HP.", effets: [{ type: "degats-si-faible", valeur: 12, seuil: 0.5 }] },
  // Whirl : moulinet AOE qui saigne (Spiked Flail).
  "tourbillon": { id: "tourbillon", nom: "Whirl", cout: 2, type: "attaque", aoe: true, nouveau: true,
    texte: "Deal 7 damage and apply 3 Bleed to ALL enemies.", effets: [{ type: "degats", valeur: 7 }, { type: "sang", valeur: 3 }] },
  ...
  "rage-sanguine": { id: "rage-sanguine", nom: "Rage", cout: 2, type: "buff", nouveau: true,
    texte: "Gain 6 Strength.", effets: [{ type: "force", valeur: 6 }] },
  ...
  "tour-de-main": { id: "tour-de-main", nom: "Sleight", cout: 1, type: "buff", nouveau: true,
    texte: "Draw 2 cards. Gain 2 Forge Heat.", effets: [{ type: "piocher", valeur: 2 }, { type: "chaleur", valeur: 2 }] },
  ...
  "nuee-toxique": { id: "nuee-toxique", nom: "Venom Nova", cout: 2, type: "attaque", portee: "range", aoe: true, nouveau: true,
    texte: "Apply 7 Poison to ALL enemies.", effets: [{ type: "poison", valeur: 7 }] },
  ...
  "soif-de-sang": { id: "soif-de-sang", nom: "Bloodthirst", cout: 1, type: "attaque", portee: "range", nouveau: true,
    texte: "Deal 3 damage, apply 3 Bleed, and heal HP equal to the target's Bleed.", effets: [{ type: "degats", valeur: 3 }, { type: "sang", valeur: 3 }, { type: "soin-par-sang-cible", valeur: 1 }] },
  ...
  "boule-de-feu": { id: "boule-de-feu", nom: "Fireball", cout: 2, type: "attaque", portee: "range", aoe: true, nouveau: true,
    texte: "Deal 8 damage and apply 3 Burning to ALL enemies.", effets: [{ type: "degats", valeur: 8 }, { type: "feu", valeur: 3 }] },
  ...
  "ralliement": { id: "ralliement", nom: "Rally", cout: 1, type: "buff", nouveau: true,
    texte: "Gain 2 Strength. Draw 2 cards.", effets: [{ type: "force", valeur: 2 }, { type: "piocher", valeur: 2 }] },
  // Aegis : gros bloc défensif + régénération (Warding Shield).
  "egide": { id: "egide", nom: "Aegis", cout: 2, type: "defense", nouveau: true,
    texte: "Gain 10 Stone and 3 Regen.", effets: [{ type: "pierre", valeur: 10 }, { type: "regen", valeur: 3 }] },
  ...
  "transpercement": { id: "transpercement", nom: "Pierce", cout: 2, type: "attaque", nouveau: true,
    texte: "Deal 6 damage to the target and the enemy behind it.",
    effets: [{ type: "degats", valeur: 6 }, { type: "eclaboussure", degats: 6 }] },
  ...
  "armure-standard": { id: "armure-standard", nom: "Standard Armor", cout: 1, type: "defense", rarete: "uncommon", nouveau: true,
    texte: "Gain 6 Stone.", effets: [{ type: "pierre", valeur: 6 }] },
  ...
  "frappe-de-gloire": { id: "frappe-de-gloire", nom: "Glory Strike", cout: 2, type: "attaque", nouveau: true,
    texte: "Deal 10 damage. Remove a random buff from the target; if one was removed, gain 4 Regen.",
    effets: [{ type: "degats", valeur: 10 }, { type: "supprimer-bonus", regen: 4 }] },
  ...
  "fauchage-soin": { id: "fauchage-soin", nom: "Healing Cleave", cout: 2, type: "attaque", aoe: true, nouveau: true,
    texte: "Deal 7 damage to ALL enemies. Heal 4 HP per enemy hit.",
    effets: [{ type: "degats-soin-cible", degats: 7, soin: 4 }] },
  ...
  "des-2": { id: "des-2", nom: "Roll 2 Dice", cout: 2, type: "buff", nouveau: true,
    texte: "Gain 1 to 6 Forge Heat at random.", effets: [{ type: "chaleur-aleatoire", min: 1, max: 6 }] },
  ...
  "rebond": { id: "rebond", nom: "Rebound", cout: 2, type: "defense", nouveau: true,
    texte: "Gain 3 Riposte: reflect melee damage you take back to the attacker. Lose 1 per trigger.",
    effets: [{ type: "riposte", valeur: 3 }] },
  ...
  "caillou": { id: "caillou", nom: "Stone", cout: 1, type: "defense", nouveau: true,
    texte: "Gain 5 Stone.",
    effets: [{ type: "pierre", valeur: 5 }, { type: "compteur-pierre", valeur: 1 }] },
  "tas-de-pierres": { id: "tas-de-pierres", nom: "Many Stone", cout: 3, type: "defense", nouveau: true,
    texte: "Gain 17 Stone. Counts as three Stone cards for Stone Age combos.",
    effets: [{ type: "pierre", valeur: 17 }, { type: "compteur-pierre", valeur: 3 }] },
  ...
  "taillade-large": { id: "taillade-large", nom: "Wide Slash", cout: 2, type: "attaque", revueArmes2H: true,
    texte: "Deal 16 damage to the target and 10 to each adjacent enemy.",
    effets: [{ type: "degats", valeur: 16 }, { type: "cleave-adjacent", valeur: 10 }] },
  "volee-d-acier": { id: "volee-d-acier", nom: "Steel Flurry", cout: 1, type: "attaque", revueArmes2H: true,
    texte: "Deal 4 damage three times.",
    effets: [{ type: "degats", valeur: 4 }, { type: "degats", valeur: 4 }, { type: "degats", valeur: 4 }] },
  ...
  "coup-de-croc": { id: "coup-de-croc", nom: "Hooking Strike", cout: 1, type: "attaque", revueArmes2H: true,
    texte: "Deal 11 damage. Apply 3 Chill.",
    effets: [{ type: "degats", valeur: 11 }, { type: "lenteur", valeur: 3 }] },
  ...
  "ouvrir-les-plaies": { id: "ouvrir-les-plaies", nom: "Opening Wounds", cout: 2, type: "attaque", revueArmes2H: true,
    texte: "Deal 22 damage. Apply 5 Bleed.",
    effets: [{ type: "degats", valeur: 22 }, { type: "sang", valeur: 5 }] },
  ...
  "frappe-sismique": { id: "frappe-sismique", nom: "Seismic Slam", cout: 4, type: "attaque", revueArmes2H: true,
    texte: "Deal 50 damage. Stun the target for 2 turns.",
    effets: [{ type: "degats", valeur: 50 }, { type: "stun", valeur: 2 }] },
  ...
  "tremblement": { id: "tremblement", nom: "Tremor", cout: 3, type: "attaque", aoe: true, revueArmes2H: true,
    texte: "Deal 15 damage to ALL enemies. If you have 20+ Stone, stun them all for 1 turn.",
    effets: [{ type: "degats", valeur: 15 }, { type: "stun-si-pierre", valeur: 1, seuil: 20 }] },
  ...
  "faux-sinistre": { id: "faux-sinistre", nom: "Grim Scythe", cout: 1, type: "attaque", revueArmes2H: true,
    texte: "Deal 20 damage. Apply 8 Bleed.",
    effets: [{ type: "degats", valeur: 20 }, { type: "sang", valeur: 8 }] },
  "arc-de-faux": { id: "arc-de-faux", nom: "Reaping Arc", cout: 3, type: "attaque", aoe: true, revueArmes2H: true,
    texte: "Deal 35 damage and apply 5 Bleed to ALL enemies.",
    effets: [{ type: "degats", valeur: 35 }, { type: "sang", valeur: 5 }] },
  "sentence-de-mort": { id: "sentence-de-mort", nom: "Death Sentence", cout: 2, type: "attaque", revueArmes2H: true,
    texte: "Deal 42 damage. Doubled if the target is below 50% HP.",
    effets: [{ type: "degats-si-faible", valeur: 42, seuil: 0.5 }] },
  "moisson": { id: "moisson", nom: "Harvest", cout: 2, type: "buff", revueArmes2H: true,
    texte: "Heal 15 HP per enemy that has Bleed.",
    effets: [{ type: "soin-par-ennemi-saignant", valeur: 15 }] },
  "fauche-d-ames": { id: "fauche-d-ames", nom: "Soul Reap", cout: 3, type: "attaque", revueArmes2H: true,
    texte: "Deal 50 damage. If the target dies, gain 5 Strength and heal 10 HP.",
    effets: [{ type: "degats", valeur: 50 }, { type: "recompense-mort", force: 5, soin: 10 }] },
};

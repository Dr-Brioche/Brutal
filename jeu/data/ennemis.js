...
const STATS_MONSTRES = {
  "gobelin-vif": { nom: "Goblin Skirmisher", niveau: 1, famille: "gobelin", pv: 16, attaque: 2, xp: 20, vitesse: 125, attaqueHits: 2, actions: [] },
  "gobelin": { nom: "Cave Goblin", niveau: 1, famille: "gobelin", pv: 20, attaque: 4, xp: 20, vitesse: 90, actions: [] },
  "gobelin-chaman": { nom: "Goblin Shaman", niveau: 2, famille: "gobelin", pv: 20, attaque: 6, xp: 30, vitesse: 95, actions: [{ type: "soigner", valeur: 15, poids: 50 }, { type: "haste-allie", valeur: 2, poids: 30 }, { type: "attaque", valeur: 6, poids: 20 }] },
  "orc-rodeur": { nom: "Orc Rogue", niveau: 3, famille: "orc", pv: 30, attaque: 5, xp: 50, vitesse: 150, attaqueHits: 2, actions: [] },
  "orc-chamane": { nom: "Orc Shaman", niveau: 4, famille: "orc", pv: 30, attaque: 11, xp: 90, vitesse: 115, actions: [{ type: "soigner", valeur: 20, poids: 45 }, { type: "haste-allie", valeur: 3, poids: 30 }, { type: "attaque", valeur: 11, poids: 25 }] },
  "orc-guerriere": { nom: "Orc Warmaiden", niveau: 4, famille: "orc", pv: 40, attaque: 12, xp: 90, vitesse: 130, actions: [] },
  "orc-guerrier": { nom: "Orc Warrior", niveau: 3, famille: "orc", pv: 34, attaque: 10, xp: 50, vitesse: 110, actions: [] },
  "orc-brute": { nom: "Orc Berserker", niveau: 5, famille: "orc", pv: 90, attaque: 25, xp: 280, vitesse: 90, actions: [], grand: true },
  "blob-jaune": { nom: "Ochre Slime", niveau: 3, famille: "blob", pv: 32, attaque: 6, xp: 50, vitesse: 108, actions: [] },
  "blob-vert": { nom: "Green Slime", niveau: 4, famille: "blob", pv: 38, attaque: 8, xp: 90, vitesse: 118, actions: [] },
  "blob-bleu": { nom: "Azure Slime", niveau: 5, famille: "blob", pv: 35, attaque: 12, xp: 140, vitesse: 128, actions: [] },
  "blob-rouge": { nom: "Crimson Slime", niveau: 5, famille: "blob", pv: 50, attaque: 8, xp: 140, vitesse: 120, actions: [] },
  "molosse": { nom: "Dire Hound", niveau: 2, famille: "animal", pv: 25, attaque: 6, xp: 30, vitesse: 105, actions: [] },
  "ogre-masque": { nom: "Masked Ogre", niveau: 3, famille: "animal", pv: 60, attaque: 15, xp: 100, vitesse: 55, actions: [], grand: true },
  "molosse-sombre": { nom: "Shadow Hound", niveau: 3, famille: "animal", pv: 30, attaque: 5, xp: 50, vitesse: 130, attaqueHits: 2, actions: [] },
  "molosse-feu": { nom: "Ember Hound", niveau: 4, famille: "animal", pv: 35, attaque: 8, xp: 90, vitesse: 125, actions: [] },
  "bear": { nom: "Cave Bear", niveau: 3, famille: "animal", pv: 40, attaque: 10, xp: 50, vitesse: 100, actions: [] },
  "bones-bear": { nom: "Bonehide Bear", niveau: 4, famille: "animal", pv: 45, attaque: 12, xp: 90, vitesse: 108, actions: [] },
  "armor-bear": { nom: "Armored War-Bear", niveau: 6, famille: "animal", pv: 100, attaque: 30, xp: 400, vitesse: 110, actions: [], grand: true },
  "warrior-mushroom1": { nom: "Toadstool Lancer", niveau: 5, famille: "mushroom", pv: 40, attaque: 12, xp: 140, vitesse: 130, actions: [] },
  "mage-mushroom": { nom: "Myconid Sage", niveau: 6, famille: "mushroom", pv: 40, attaque: 16, xp: 200, vitesse: 140, actions: [{ type: "soigner", valeur: 30, poids: 45 }, { type: "haste-allie", valeur: 4, poids: 30 }, { type: "attaque", valeur: 15, poids: 25 }] },
  "white-katana-mushroom": { nom: "Myconid Ronin", niveau: 6, famille: "mushroom", pv: 42, attaque: 5, xp: 200, vitesse: 170, attaqueHits: 3, actions: [] },
  ...
  "tour-de-siege-gobeline": { nom: "Goblin Siege Tower", niveau: 12, famille: "gobelin", pv: 150, attaque: 50, xp: 4000, vitesse: 150, actions: [], grand: true },
  "gobelin-kaboom": { nom: "Goblin Kaboom", niveau: 6, famille: "gobelin", pv: 80, attaque: 0, xp: 200, vitesse: 150, actions: [] },
  "gobelin-de-siege": { nom: "Siege Goblin", niveau: 3, famille: "gobelin", pv: 30, attaque: 8, xp: 50, vitesse: 120, actions: [] },
  "gobelin-de-siege-etandart": { nom: "Siege Standard-Bearer", niveau: 6, famille: "gobelin", pv: 50, attaque: 25, xp: 200, vitesse: 160, actions: [{ type: "buff-allie", valeur: 2, poids: 60 }, { type: "attaque", valeur: 25, poids: 30 }, { type: "renforts", valeur: 0, poids: 10 }] },
  "gobelin-blinde": { nom: "Armored Goblin", niveau: 8, famille: "gobelin", pv: 120, attaque: 20, xp: 500, vitesse: 160, actions: [], grand: true },
  "gobelin-sans-blindage1": { nom: "Mace Goblin", niveau: 5, famille: "gobelin", pv: 40, attaque: 15, xp: 140, vitesse: 150, actions: [] },
  "gobelin-sans-blindage2": { nom: "Shield Goblin", niveau: 5, famille: "gobelin", pv: 60, attaque: 5, xp: 140, vitesse: 120, actions: [{ type: "bouclier-allie", valeur: 15, poids: 100 }] },
  "fou-du-roi": { nom: "The King's Fool", niveau: 10, famille: "fou", pv: 100, attaque: 0, xp: 200, vitesse: 200, actions: [] },
};
// <<FIN-MONSTRES-AUTO>>
...
export const ENNEMIS = [
  ...
  },
  {
    ...
    // RENFORTS : quel monstre il appelle pour combler les emplacements libres
    // (action « renforts », cf. systems/combat.js). Réglable par monstre.
    renfortId: "gobelin-de-siege",

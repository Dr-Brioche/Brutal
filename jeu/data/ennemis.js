...
const STATS_MONSTRES = {
  ...
  "orc-rodeur": { nom: "Orc Rogue", niveau: 3, famille: "orc", pv: 40, attaque: 6, xp: 22, vitesse: 15, actions: [] },
  ...
  "white-katana-mushroom": { nom: "Myconid Ronin", niveau: 4, famille: "mushroom", pv: 45, attaque: 7, xp: 30, vitesse: 18, actions: [] },
  ...
  "lapin-stage2": { nom: "Feral Hare", niveau: 7, famille: "lapin", pv: 55, attaque: 9, xp: 0, vitesse: 20, actions: [] },
  "lapin-stage3": { nom: "Bloodfang Horror", niveau: 10, famille: "lapin", pv: 150, attaque: 17, xp: 130, vitesse: 26, actions: [] },
};
// <<FIN-MONSTRES-AUTO>>

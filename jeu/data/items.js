...
export const ITEMS = {
  ...
  "lance": { id: "lance", nom: "Spear", categorie: "arme", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 3 }, icone: "#9a8a6a", mains: 1, cartes: ["taillade", "taillade", "taillade", "frappe"] },
  ...
  "masse": { id: "masse", nom: "Mace", categorie: "arme", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#9aa0a6", mains: 1, cartes: ["coup-lourd", "coup-lourd", "garde", "garde"] },
  ...
  "marteau-de-pierre": { id: "marteau-de-pierre", nom: "Stone Hammer", categorie: "arme", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#8a8a82", mains: 1, cartes: ["choc-de-pierre", "garde", "garde", "frappe"] },
  ...
  "fourche": { id: "fourche", nom: "Pitchfork", categorie: "arme", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 3 }, icone: "#8a8a6a", mains: 1, cartes: ["double-frappe", "double-frappe", "dard-empoisonne"] },
  ...
  "hache-berserk": { id: "hache-berserk", nom: "Berserker Axe", categorie: "arme", rarete: "uncommon", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#b8431e", mains: 1, cartes: ["coup-imprudent", "flexion", "taillade", "frappe"] },
  "marteau-guerre": { id: "marteau-guerre", nom: "Warhammer", categorie: "arme", rarete: "uncommon", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#82827a", mains: 1, cartes: ["seisme", "choc-de-pierre", "mur-de-fer", "frappe"] },
  "dagues-jumelles": { id: "dagues-jumelles", nom: "Twin Daggers", categorie: "arme", rarete: "uncommon", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#b0b4bc", mains: 1, cartes: ["volee", "double-frappe", "frappe", "frappe"] },
  "lame-bourreau": { id: "lame-bourreau", nom: "Executioner's Blade", categorie: "arme", rarete: "uncommon", nouveau: true,
    taille: { l: 1, h: 3 }, icone: "#6a4a5a", mains: 1, cartes: ["execution", "coup-lourd", "taillade", "frappe"] },
  "baguette-cristal": { id: "baguette-cristal", nom: "Crystal Wand", categorie: "arme", rarete: "uncommon", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#7a6ad9", mains: 1, cartes: ["eclair-arcanique", "eclair-arcanique", "etincelle", "frappe"] },
  "fleau-cloute": { id: "fleau-cloute", nom: "Spiked Flail", categorie: "arme", rarete: "uncommon", nouveau: true,
    taille: { l: 1, h: 2 }, icone: "#8a5a5a", mains: 1, cartes: ["tourbillon", "entaille", "taillade", "frappe"] },
  ...
  "gilet-rembourre": { id: "gilet-rembourre", nom: "Padded Vest", categorie: "armure", rarete: "commun", nouveau: true,
    taille: { l: 2, h: 2 }, icone: "#8a7a5a", planche: "images/heros/nain.png", armureDepart: 5, cartes: ["mur-de-fer", "mur-de-fer"] },
  "cotte-mailles": { id: "cotte-mailles", nom: "Chainmail", categorie: "armure", rarete: "commun", nouveau: true,
    taille: { l: 2, h: 2 }, icone: "#9aa0a6", planche: "images/heros/nain.png", armureDepart: 8, cartes: ["garde", "garde", "garde"] },
  ...
  "plaque-de-fer": { id: "plaque-de-fer", nom: "Iron Plate", categorie: "armure", rarete: "uncommon", nouveau: true,
    taille: { l: 2, h: 2 }, icone: "#a8aeb8", planche: "images/heros/nain.png", armureDepart: 12, cartes: ["fortification", "mur-de-fer", "mur-de-fer"] },
  "armure-cloutee": { id: "armure-cloutee", nom: "Spiked Armor", categorie: "armure", rarete: "uncommon", nouveau: true,
    taille: { l: 2, h: 2 }, icone: "#7a7a72", planche: "images/heros/nain.png", armureDepart: 10, cartes: ["garde", "garde", "mur-de-fer"],
  ...
  "peau-berserk": { id: "peau-berserk", nom: "Berserker Hide", categorie: "armure", rarete: "uncommon", nouveau: true,
    taille: { l: 2, h: 2 }, icone: "#9a5a3a", planche: "images/heros/nain.png", armureDepart: 8, cartes: ["rage-sanguine", "garde", "mur-de-fer"] },

  // ---- Bottes : COMMONS (4) + UNCOMMONS (3) ----------------------------------
  "bottes-usees": { id: "bottes-usees", nom: "Worn Boots", categorie: "botte", rarete: "commun", nouveau: true,
    taille: { l: 2, h: 1 }, icone: "#7a6a52", celeritePct: 10, vitesseBonus: 5, cartes: ["mains-vives"] },
  "bottes-cuir": { id: "bottes-cuir", nom: "Leather Boots", categorie: "botte", rarete: "commun", nouveau: true,
    taille: { l: 2, h: 1 }, icone: "#8a6a4a", celeritePct: 12, vitesseBonus: 8, cartes: ["celerite-vive"] },
  "bottes-voyage": { id: "bottes-voyage", nom: "Traveler Boots", categorie: "botte", rarete: "commun", nouveau: true,
    taille: { l: 2, h: 1 }, icone: "#9a8a6a", celeritePct: 8, vitesseBonus: 15, cartes: ["frappe"] },
  "sandales": { id: "sandales", nom: "Sandals", categorie: "botte", rarete: "commun", nouveau: true,
    taille: { l: 2, h: 1 }, icone: "#b0a888", celeritePct: 15, vitesseBonus: 3, cartes: ["etincelle"] },
  ...
  "gants-voleur": { id: "gants-voleur", nom: "Thief's Gloves", categorie: "gant", rarete: "uncommon", nouveau: true,
    taille: { l: 2, h: 1 }, icone: "#4a7a6a", cartes: ["tour-de-main", "mains-vives"] },
  ...
  "anneau-de-fer": { id: "anneau-de-fer", nom: "Iron Ring", categorie: "bague", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 1 }, icone: "#9aa0a6", cartes: ["garde", "garde"] },
  ...
  "charme-os": { id: "charme-os", nom: "Bone Charm", categorie: "collier", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 1 }, icone: "#c8c0a8", cartes: ["entaille", "garde"] },
  "pendentif-chaud": { id: "pendentif-chaud", nom: "Warm Pendant", categorie: "collier", rarete: "commun", nouveau: true,
  ...
  "porte-bonheur": { id: "porte-bonheur", nom: "Lucky Charm", categorie: "collier", rarete: "commun", nouveau: true,
    taille: { l: 1, h: 1 }, icone: "#5a9d5a", cartes: ["mains-vives", "mains-vives"] },
